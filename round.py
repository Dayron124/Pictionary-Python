"""
Represents a round of the game, storing things like word, time, skips, drawing players and more.
"""
...
class Round(object):
    ...
    def player_left(self, player):
        """
        removes player that left from score and list 
        :param player: Player
        :return: None
        """
        #might not be able to use player as key in object
